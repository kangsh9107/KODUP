...
public class InfoshareBoardReplVo {
	...
	//infoshareboardmapper.xml 에서 insertRepl의 파라미터 타입 InfoshareBoardReplVo로 한번에 받아서 처리할려고 그냥추가함,시간부족
	...
	//infoshare.jsp에서 button id:repl_inner_display_onkey2 , c:if조건문걸기위해 필요
