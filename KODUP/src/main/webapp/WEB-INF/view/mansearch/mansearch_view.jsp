...
<div class="container text-left" style="margin-bottom:70px;">
	<div class="row">
		<c:if test="${sessionId ne null }">
			<div class="col-1" style="padding: 0;">
				<span> 
					<img id="premium_review_writer_icon" src="upload/${sessionScope.profile_img }" style="width: 42px; height: 42px; margin-top: 19px; border-radius:50%;">
				</span>
			</div>
			<div class="col-11">
	...
	<c:if test="${sessionId ne null }">
		<button class="premium_review_insert" style="float: right; margin-top: 15px;">리뷰등록</button>
	</c:if>
</div>
<br/><br/>
				...
				<div class="row">
					<div class="col premium_review_wrap">
						<div class="premium_review_writer">
							<span>
								<img id="premium_review_writer_icon" src="upload/${vo.profile_img }">
							</span>
							<span>|</span>
							<span>
						...
						<div class="premium_review_doc_wrap">
							...
							<div class="doc_blind_wrap">
								<c:if test="${sessionId ne null && vo.status==0 && vo.writer_id ne sessionId}">
									<button type="button" class="premium_review_payment" onclick='premiumView(this.form)'>프리미엄 리뷰 보기</button>
								</c:if>
							</div>
						</div>
					</div>
