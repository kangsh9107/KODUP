...
<body>
	<form class='mansearch_frm' method='post'>
		...
		<div class="container text-center">
			<div class="row justify-content-md-center">
				<div class="col mansearch_view_subject">
					...
					</span><br /> <span class="deadline" style='font-weight: bold;'> <svg
		...
		<br /> <label
			style="font-weight: bold; font-size: 0.9rem; margin-bottom: 10px; margin-top: -10px;">프로젝트
			소개</label>
	...
	<div class="container text-left" style="margin-bottom:70px;">
			...
			<c:if test="${sessionId ne null }">
				<div class="col-1" style="padding: 0;">
					<span> <img id="premium_review_writer_icon"
						...
						style="width: 42px; height: 42px; margin-top: 19px;">
					</span>
				</div>
				<div class="col-11">
		...
		<c:if test="${sessionId ne null }">
			<button class="mansearch_insert"
				style="float: right; margin-top: 15px;">리뷰등록</button>
		</c:if>
	</div>
	<br />
	<br />
						...
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn btn-primary review_payment"
									onclick='premiumView()'>네, 보겠습니다.</button>
							</div>
						</div>
					</div>
				</div>
