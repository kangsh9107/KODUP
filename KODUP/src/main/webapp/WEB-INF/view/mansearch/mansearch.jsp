		...
		<div class="col-md-12" style="padding: 20px 10px 0 10px;">
			...
			<c:choose>
				<c:when test="${pVo.nowPage != pVo.totPage }">
					<label style="float: right; padding: 0 0 0 10px;">
						<input type="button" class="btn btnNext" value="&#xf061;" onclick="movePage(${pVo.nowPage + 1 })" style="font-family: FontAwesome; padding: 0; margin-right: -12px;">
					</label>
				</c:when>
				<c:otherwise>
			...
			<c:choose>
				<c:when test="${pVo.nowPage != 1 }">
					<label style="float: right; padding: 0 0 0 10px;">
						<input type="button" class="btn btnPrevious" value="&#xf060;" onclick="movePage(${pVo.nowPage - 1 })" style="font-family: FontAwesome; padding: 0;">
					</label>
				</c:when>
				<c:otherwise>
					<label style="float: right; padding: 0 0 0 10px; cursor: default; pointer-events: none;">
