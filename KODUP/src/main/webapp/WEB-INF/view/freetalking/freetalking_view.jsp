		...
		<c:when test="${fbVo.board_delete eq 0}">
			...
			<div id="freetalking_view_btnzone" style="margin-top:30px;" >
				<c:if test="${fbVo.id eq sessionScope.sessionId}">
					<input type="button" class="btnUpdateFreetalking freetalking_view_originalBtn" style="vertical-align:top;"value="수정">
			...
			<c:if test="${sessionScope.sessionId ne null }">
				<div id="freetalking_view_repl_insert" style=" border:1px solid #DCDCDC; padding : 20px 30px 50px 30px; border-radius:30px;">
					...
					<div class="view_summernote_section">
						<span>
							<img id="freetalking_view_repl_insert_profileimage_file" src="upload/${sessionScope.profile_img}" style="border-radius:50%;">
						</span>
			...
			<div id="freetalking_view_repl_list" style="margin-top:50px;"> 
				...
				<div style="display:none;"> <!-- style="visibility:hidden;" -->
					...
					<c:if test ='${replList.deep eq 0}'>
						...
						<div class="freetalking_view_repl_profile" style="font-size:13px; margin-top:15px;">
							<span class="freetalking_view_repl_profile_profileimage"><!--댓글작성자프로필사진+닉네임+댓글작성시간 한줄로 붙이기위해 inline요소인 span태그사용 -->
								<img class="freetalking_view_repl_profile_profileimage_file" src="upload/${replList.profile_img}"style="border-radius:50%;" >
							</span>
						...
						<div id="repl_insert_section${replList.repl_sno}" style="display:none; font-size:15px; margin-left:50px;">
							<span>
								<img id="freetalking_view_repl_inner_insert_profileimage_file" src="upload/${sessionScope.profile_img}"><!-- 세션아이디의 프로필이미지가 들어감 -->
							</span>
							<!-- 대댓글인서트_내용 서머노트 -->
