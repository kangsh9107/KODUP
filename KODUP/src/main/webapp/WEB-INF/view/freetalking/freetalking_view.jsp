...
<form id="freetalking_view">
	...
	<div id="freetalking_view_horsehead">
		<a href="#" class="btnBoardtype">${fbVo.boardtype}</a><!-- ${fbVo.boardtype} -->
		/
	...
	<c:choose>
		<c:when test="${fbVo.board_delete eq 0}">
			...
			<div id="freetalking_view_btnzone" style="margin-top:30px;" >
				...
				<input type="button" class="btnList  freetalking_view_originalBtn" style="vertical-align:top;"value="목록">
			</div>
			...
			<c:if test="${sessionScope.sessionId ne null }">
				<div id="freetalking_view_repl_insert" style=" border:1px solid #DCDCDC; padding : 20px 30px 50px 30px; border-radius:30px;">
					...
					<div class="view_summernote_section">
						<span>
							<img id="freetalking_view_repl_insert_profileimage_file" src="images/${sessionScope.profile_img}" style="border-radius:50%;">
						</span>
				...
				<div style="display:none;"> <!-- style="visibility:hidden;" -->
					...
					<c:if test ='${replList.deep eq 0}'>
						...
						<div id="repl_insert_section${replList.repl_sno}" style="display:none; font-size:15px; margin-left:50px;">
							<span>
								<img id="freetalking_view_repl_inner_insert_profileimage_file" src="images/${sessionScope.profile_img}"><!-- 세션아이디의 프로필이미지가 들어감 -->
							</span>
							<!-- 대댓글인서트_내용 서머노트 -->
