		...
		<form name="board_search_form" class="board_search_form" method="post">
			<div class="row">
				<div class="col-md-12" style="padding-left: 10px; padding-right: 10px;">
					...
					<c:choose>
						...
						<c:otherwise>
							<input type="button" style="visibility: hidden;" class="btn btnNotificationInsert" value="&#xf304; 작성하기" style="font-family: FontAwesome; float: left;">
						</c:otherwise>
					</c:choose>
					<!-- HORSEHEAD -->
					<input type="radio" onclick="runQna('공지사항')" class="btn-check" name="horsehead_radio" id="horsehead_radio1" ${cbpVo.horsehead eq '공지사항' ? 'checked' : '' }>
					<label for="horsehead_radio1">공지사항</label>
					<input type="radio" onclick="runQna('이벤트')" class="btn-check" name="horsehead_radio" id="horsehead_radio2" ${cbpVo.horsehead eq '이벤트' ? 'checked' : '' }>
					<label for="horsehead_radio2">이벤트</label>
					<input type="radio" onclick="runQna('')" class="btn-check" name="horsehead_radio" id="horsehead_radio3" ${cbpVo.horsehead eq '' ? 'checked' : '' }>
			...
			<div class="row-fluid" style="border-top: 1px solid #dee2e6; margin: 25px 0 25px 0;">
				<div class="col-md-12" style="padding: 20px 10px 0 10px;">
					...
					<input type="search" name="findStr" value="${cbpVo.findStr }" class="inputSearch" placeholder="공지사항 내에서 검색" autocomplete="off">
