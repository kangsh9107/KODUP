...
function infoshare_view_findHashtag(hashtag){
...
$('#btn_viewpage_thumbup').on('click', function(){
    var param = $('#infoshare_view').serialize();
    var thumb = $('#thumb').text();
    $('#thumb').text(Number(thumb)+1);
    $.post("/infoshare/infoshare_view/thumbup", param, function(data){})
...
$('#btn_viewpage_thumbdown').on('click', function(){
    ...
    var thumb = $('#thumb').text();
    $('#thumb').text(Number(thumb)-1);
    $.post("/infoshare/infoshare_view/thumbdown", param, function(data){})
    	var thumb_standard = $('#thumb_standard').val();
    if(Number(thumb) <= thumb_standard){
...
$('.btnDeleteR').on('click', function(){
    ...
    var param = $('#infoshare_view').serialize();
    $.post("/infoshare/infoshare_view/deleteR", param, function(data){
       $('#center').html(data);
    })
})
...
function view_repl_deleteR(repl_sno){
    ...
    var param = $('#infoshare_view').serialize();
    $.post("/infoshare/infoshare_view/ReplDeleteR", param, function(data){
       $('#center').html(data);
    })
}
...
function view_insert_repl(){
	...
	var param = $('#infoshare_view').serialize();
    $.post("/infoshare/infoshare_view/insertRepl", param, function(data){
       $('#center').html(data);
    })
...
//대댓서머노트 코드 가져오기
	...
	var param = $('#infoshare_view').serialize();
    $.post("/infoshare/infoshare_view/insertInnerRepl", param, function(data){
       $('#center').html(data);
    })
...
function updateReplUpdate(repl_sno){
    ...
    var param = $('#infoshare_view').serialize();
    $.post("/infoshare/infoshare_view/ReplUpdateR", param, function(data){
       $('#center').html(data);
     })
}